...
const OrganizationChartContent = ({ employees, tree, compact = false, showLevels = true, showBandCode = true }) => {
    ...
    const c = compact ? {
        ...
        teamW:      showBandCode ? 'w-[115px]' : 'w-[92px]',
        teamHeaderH: 'min-h-[36px] pt-0.5 pb-2',
        teamHeaderSz: 'text-[10px]',
        memberPad:  showBandCode ? 'px-0.5 pt-0.5 pb-2.5' : 'px-0 pt-0.5 pb-2.5',
        memberSz:   'text-[9px]',
        ...
        deptFontSz: 'text-sm',
        deptPad:    'h-10 px-6',
        teamW:      showBandCode ? 'w-56' : 'w-44',
        teamHeaderH: 'h-8',
        teamHeaderSz: 'text-xs',
        memberPad:  showBandCode ? 'p-1.5' : 'p-1 px-0.5',
        memberSz:   'text-xs',
